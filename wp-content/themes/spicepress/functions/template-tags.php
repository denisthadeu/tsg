...
@media (min-width: <?php echo $menu_breakpoint+1; ?>px) {
	...
	.navbar-custom .dropdown-menu { 
		border-top: 2px solid #0faf19 !important;
		border-bottom: 2px solid #0faf19 !important;
	...
	.navbar-custom .open .dropdown-menu { background-color: #16C721 !important; }
...
@media (max-width: <?php echo $menu_breakpoint; ?>px) {
	...
	.navbar-custom .navbar-nav { background-color: #16C721; float: none!important; margin: 0px }
...
@media (max-width: 500px) { 
	...
	.navbar-toggle { float: none; margin: 10px auto 25px; }
	/*Navbar Overlapped*/
	.navbar-overlapped { position: relative; background-color: #16C721; border-bottom: 1px solid #4c4a5f; }
...
.navbar-classic { z-index: 20; background-color: #16C721; }
